                ...
                <Card>
                    <CardContent
                        ...
                        <div className="flex-grow text-center md:text-left">
                            ...
                            <p className="text-sm text-gray-500">{borrower.displayId}</p>
                ...
                <div className="space-y-6">
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-3">
                            <a href={borrower.payslips.documentUrls[0]} target="_blank" rel="noopener noreferrer">
                                <Button variant="outline" className="w-full justify-start">
                                    <FileText className="w-4 h-4 mr-2"/> View Payslip
                                </Button>
                            </a>
                            <a href={borrower.bankStatement.documentUrls[0]} target="_blank" rel="noopener noreferrer">
                                <Button variant="outline" className="w-full justify-start">

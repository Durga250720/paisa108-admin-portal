            ...
            <div className={`${styles.cardContainer} overflow-auto mt-2 bg-white shadow-sm rounded`}>
                <table className="w-full">
                    ...
                    <tr className="border-b border-gray-200">
                        <th className="sticky px-4 top-0 z-10 bg-primary-50 text-primary text-sm font-medium text-left p-3">Application
                            ID
                        </th>
                        <th className="sticky top-0 z-10 bg-primary-50 text-primary text-sm font-medium text-left p-3">Borrower</th>
                        <th className="sticky top-0 z-10 bg-primary-50 text-primary text-sm font-medium text-left p-3">Loan
                            Amount
                        </th>
                    ...
                    <span className={`text-sm font-normal ${getCibilColor(app.cibil)}`}>
                      {app.cibil || '0'}
                                ...
                                <td className="py-4 px-4 text-sm font-normal">
                                    <Badge
                                        className={`${getStatusColor(app.applicationStatus)} hover:bg-color-none px-3 py-1`}>
                        ...
                        {actionType === 'reject' && (
                            <div className="pt-4">
                                <label htmlFor="rejectionReason"
                                       className="block text-sm font-medium text-gray-700 mb-1">Reason for
                                    Rejection <sup>*</sup></label>
                                <Input
                                    id="rejectionReason"
                                    value={remark}
